...
The quarkus-cucumber extension provides a `@ScenarioScope` annotation which is documented on [Quarkiverse](https://docs.quarkiverse.io/quarkus-cucumber/dev/index.html#_scenarioscope).
