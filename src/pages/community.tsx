  ...
  return <Layout>
    <main>
      ...
      <div className="container text--center padding-vert--lg">
        ...
        <p className="readable-blurb margin-bottom--lg">Wherever you interact with the Cucumber community,<br/>always remember to
          respect and uphold our <Link to="/conduct">Code of Conduct</Link>.</p>
        <div className="row text--center">
          ...
          <div className="col col--4">
            ...
            />
            <p className="padding-horiz--sm">
              If you have questions about using Cucumber, or ideas for improving it, try our <strong>GitHub
              Discussions</strong>.
            </p>
            <Link className="button button--secondary" to="https://github.com/orgs/cucumber/discussions">Browse
              Discussions</Link>
          </div>
          <div className="col col--4">
            <img
            ...
            />
            <p className="padding-horiz--sm">
              Stuck? Many people use <strong>Stack Overflow</strong> to ask or answer questions about Cucumber.
            </p>
            <Link className="button button--secondary" to="https://stackoverflow.com/questions/tagged/cucumber">Find
              Answers</Link>
          </div>
        </div>
      </div>
